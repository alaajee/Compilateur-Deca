...
public class ManualTestContext {
    public static void main(String[] args) throws IOException {
        ...
        // Déclarations des variables : int x = 1; et int y = 2;
        Initialization initX = new Initialization(new IntLiteral(1));
        initX.setLocation(new Location(1, 10, "test.deca"));
        listDeclVar.add(new DeclVar(intType, idX, initX));

        Initialization initY = new Initialization(new IntLiteral(2));
        ...
        // Soustraction : (2 * x) - (3 * y)
        Minus resultExpression = new Minus(twoTimesX, threeTimesY);
        resultExpression.setLocation(new Location(3, 18, "test.deca"));

        // Instruction : z = (2 * x - 3 * y);
        Assign assignZ = new Assign(idZ, resultExpression);
